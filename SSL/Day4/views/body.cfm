...
<cfloop query="data">
	<cfoutput>#username#, #email#</cfoutput>
		<a href="?action=delete&userID=<cfoutput>#userID#</cfoutput>">Delete</a>
		<a href="?action=addform">Add</a>
		<a href="?action=updateform&userID=<cfoutput>#userID#</cfoutput>">Update</a>
	<br/>
</cfloop>